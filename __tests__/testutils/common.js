  ...
  describe('.getConnectData()', () => {
    test('should return the correct url and token', async () => {
      ...
      const expectedUrl = isBrowser
        ? 'https://connect.wealthica.com/connect?client_id=test&lang=en&origin=http%3A%2F%2Flocalhost&theme=light&providers_per_line=2'
        : 'https://connect.wealthica.com/connect?client_id=test&lang=en&theme=light&providers_per_line=2';
